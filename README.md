...
- [Domain Setup](docs/domain-setup.md): migrating a domain to Route 53
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_cloudfront"></a> [cloudfront](#module\_cloudfront) | pomo-studio/ssr-cloudfront/aws | 0.3.5 |
...
| <a name="module_storage"></a> [storage](#module\_storage) | pomo-studio/ssr-storage/aws | 0.2.5 |
